...
///
/// There is also a bottombar which displays all the possible [Category] and allow the user to quickly switch to that [Category]
class EmojiPickerLegacy extends StatefulWidget {
  @override
  _EmojiPickerLegacyState createState() => new _EmojiPickerLegacyState();
...
class _EmojiPickerLegacyState extends State<EmojiPickerLegacy> {
  static const platform = const MethodChannel("emoji_picker");
